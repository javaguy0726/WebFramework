...
/**
 * Utility class for operating Excel files including READ, WRITE, MERGE and so
 * on.
 * 
 * @author : Renta
 * @Version : 1.01
...
public class ExcelUtil {
	/**
	 * The default line started by(Index: 0)
	 */
	...
	/**
	 * Read excel content. It will automatically choose the correct method according to different Excel tool version (Usually 2003 or 2007). 
	 * 
	 * @param xlsPath
	 * @throws IOException
	 */
	public List<Row> readExcel(String xlsPath) throws IOException {
		...
		if (xlsPath.equals("")) {   
			throw new IOException("File path can not be empty!");
		} else {
	...
	/**
	 * Set the start position of reading content. Default to 0.
	 * 
	 * @param startReadPos
	 */
