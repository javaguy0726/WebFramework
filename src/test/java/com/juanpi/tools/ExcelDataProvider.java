 ...
 * @author renta
 * @description:  
 * Read the Excel data. The excel files are placed under resources/com/juanpi/data. 
 * File name is like TestClassName.xls and Sheet name is like MethodName.
 * The 1st line of excel file is the Map Key
 */
...
public class ExcelDataProvider implements Iterator<Object[]> {
	...
	public ExcelDataProvider(String moduleName, String caseNum) {
		...
		try {
			path = "src/test/resources/com/juanpi/data/" + moduleName + ".xls";
